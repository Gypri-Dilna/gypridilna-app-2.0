                ...
                <div className="pt-2">
                    {googleClientId ? (
                        <div className="space-y-2">
                            ...
                            <button
                                type="button"
                                onClick={() => { setShowClientIdConfig(true); setIsGoogleModalOpen(true); }}
                                className="w-full text-center text-[11px] text-gray-400 hover:text-brand-teal font-mono transition"
                            >
                                ⚙️ Edit Google Client ID
                            </button>
                        </div>
                    ) : (
                        <button
