...
export const Header: React.FC<HeaderProps> = ({
    ...
    return (
        <>
            ...
            {/* Desktop & Tablet Sidebar (Permanently Anchored Viewport: inset-y-0 left-0 w-64) */}
            <aside className="hidden md:flex md:flex-col w-64 flex-shrink-0 bg-brand-dark border-r border-brand-border fixed inset-y-0 left-0 z-30 font-sans overflow-hidden select-none">
                <div className="flex flex-col h-full overflow-hidden">
                    ...
                    <div className="p-3 border-t border-brand-border bg-brand-dark flex-shrink-0 relative z-20 space-y-2">
