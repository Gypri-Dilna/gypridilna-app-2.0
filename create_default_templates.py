"""
Default P-touch Template Configurator for 18mm & 9mm TZe Tape
Creates template documentation and placeholder files for P-touch Editor
"""
import os
...
README_PATH = os.path.join(TEMPLATES_DIR, "README_PTOUCH.md")

readme_content = """# P-touch Editor Template Setup for Brother PT-D460BTVP
...
2. **`label_9mm.lbx`** (9mm TZe Tape - Compact 9mm layout)
   - Object Named `location_code`: Text object for Location Code
   - Object Named `qr_code`: QR Barcode object
...
print(f"Created template documentation in {README_PATH}")
